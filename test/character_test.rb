...
describe CharacterLegacy do
  it "rolls for character class, magic items, stats, name, alignment, description" do
    ...
    assert_instance_of CharacterLegacy::Stats, result.stats
  ...
  it "handles every ethnicity" do
    ...
    CharacterLegacy::HUMAN_HEIGHT_WEIGHT_BY_ETHNICITY.each_key do |ethnicity|
      character = CharacterLegacy.new(2, ethnicity:, character_class: "Fighter")
  ...
  it "generates combat stats line" do
    character = CharacterLegacy.new(2, character_class: "Fighter")
