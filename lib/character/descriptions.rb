...
class Character
  module Descriptions
    ...
    HUMAN_HAIR_COLOR_BY_ETHNICITY["krysean"] = HUMAN_HAIR_COLOR_BY_ETHNICITY["celdorean"]
    ...
    HUMAN_HAIR_COLOR_BY_ETHNICITY["skysos"] = HUMAN_HAIR_COLOR_BY_ETHNICITY["somirean"]
    ...
    HUMAN_HAIR_TEXTURE_BY_ETHNICITY["corcanoan"] = HUMAN_HAIR_TEXTURE_BY_ETHNICITY["celdorean"]
    ...
    HUMAN_HAIR_TEXTURE_BY_ETHNICITY["rornish"] = HUMAN_HAIR_TEXTURE_BY_ETHNICITY["jutlandic"]
    ...
    HUMAN_HAIR_TEXTURE_BY_ETHNICITY["syrnasan"] = HUMAN_HAIR_TEXTURE_BY_ETHNICITY["krysean"]
    ...
    def human(ethnicity, str_bonus, sex = "m")
      ...
      "Sex: #{sex}, Build: #{build}, Height: #{height_string}, Weight: #{weight_string}, Eyes: #{eye_color}, " \
